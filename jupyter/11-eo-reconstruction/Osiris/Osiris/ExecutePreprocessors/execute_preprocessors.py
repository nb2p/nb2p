...
class SelfReproducibilityCheckPreprocessor(ExecutePreprocessor):
    ...
    def preprocess(self, nb, resources):
        ...
        return super(SelfReproducibilityCheckPreprocessor, self).preprocess(
            nb, resources
        )
...
class StatusInspectionPreprocessor(ExecutePreprocessor):
    ...
    def preprocess_for_inspecting_status_of_certain_line(
        self, nb, resources, target_line_index
    ):
        copy_nb_cells = nb.cells
