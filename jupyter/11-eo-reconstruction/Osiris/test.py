...
class TestOsiris(unittest.TestCase):
    ...
    def test_normal_executability(self):
        interface = Osiris.UserInterface(
            test_executability_notebook_path, "normal", verbose
        )
    ...
    def test_OEC_executability(self):
        interface = Osiris.UserInterface(
            test_executability_notebook_path, "OEC", verbose
        )
        is_executable = interface.analyse_executability()
        self.assertEqual(is_executable, True)
    ...
    def test_dependency_executability(self):
        interface = Osiris.UserInterface(
            test_executability_notebook_path, "dependency", verbose
        )
        is_executable = interface.analyse_executability()
        self.assertEqual(is_executable, True)
    ...
    def test_top_down_strong_reproducibility(self):
        interface = Osiris.UserInterface(
            test_reproducibility_notebook_path, "normal", verbose
        )
        num_of_matched_cells, num_of_cells, _, _, _ = interface.analyse_reproducibility(
            "strong"
        )
    ...
    def test_OEC_strong_reproducibility(self):
        interface = Osiris.UserInterface(
            test_reproducibility_notebook_path, "OEC", verbose
        )
        num_of_matched_cells, num_of_cells, _, _, _ = interface.analyse_reproducibility(
            "strong"
        )
    ...
    def test_dependency_strong_reproducibility(self):
        interface = Osiris.UserInterface(
            test_reproducibility_notebook_path, "dependency", verbose
        )
        num_of_matched_cells, num_of_cells, _, _, _ = interface.analyse_reproducibility(
            "strong"
        )
    ...
    def test_top_down_best_effort_reproducibility(self):
        interface = Osiris.UserInterface(
            test_best_effort_notebook_path, "normal", verbose
        )
        num_of_matched_cells, num_of_cells, _, _, _ = interface.analyse_reproducibility(
            "best_effort"
        )
    ...
    def test_dependency_best_effort_reproducibility(self):
        interface = Osiris.UserInterface(
            test_best_effort_notebook_path, "dependency", verbose
        )
        num_of_matched_cells, num_of_cells, _, _, _ = interface.analyse_reproducibility(
            "best_effort"
        )
    ...
    def test_top_down_repeatablility(self):
        interface = Osiris.UserInterface(
            test_repeatablility_notebook_path, "normal", verbose
        )
        (
            num_of_reproducible_cells,
            num_of_cells,
            _,
    ...
    def test_OEC_repeatablility(self):
        interface = Osiris.UserInterface(
            test_repeatablility_notebook_path, "OEC", verbose
        )
        (
            num_of_reproducible_cells,
            num_of_cells,
    ...
    def test_dependency_repeatablility(self):
        interface = Osiris.UserInterface(
            test_repeatablility_notebook_path, "dependency", verbose
        )
        (
            num_of_reproducible_cells,
            num_of_cells,
    ...
    def test_top_down_debug_for_a_cell(self):
        interface = Osiris.UserInterface(
            test_debug_for_a_cell_notebook_path, "normal", verbose
        )
    ...
    def test_OEC_debug_for_a_cell(self):
        interface = Osiris.UserInterface(
            test_debug_for_a_cell_notebook_path, "OEC", verbose
        )
    ...
    def test_dependency_debug_for_a_cell(self):
        interface = Osiris.UserInterface(
            test_debug_for_a_cell_notebook_path, "dependency", verbose
        )
        problematic_statement_index = interface.analyse_status_difference_for_a_cell(1)
        self.assertEqual(problematic_statement_index, 10)
    ...
    def test_image_IPythonDisplay(self):
        interface = Osiris.UserInterface(
            test_IPythonDisplay_notebook_path, "OEC", verbose
        )
        num_of_matched_cells, num_of_cells, _, _, _ = interface.analyse_reproducibility(
            "weak"
        )
    ...
    def test_return_fix_statement(self):
        ...
        fix_statement = return_fix_statement_for_random_statement(
            statement, import_statement_lst
        )
        ...
        print(statement, import_statement_lst, fix_statement)
        # 4
        statement, import_statement_lst = "d = np.random.normal(0, 0.2, 5000)", [
            "import numpy as np"
        ]
        fix_statement = return_fix_statement_for_random_statement(
            statement, import_statement_lst
        ...
        print(statement, import_statement_lst, fix_statement)
        # 6
        statement, import_statement_lst = "    y_var2 = np.random.randint(5, 8, 10)", [
            "import numpy as np"
        ]
        fix_statement = return_fix_statement_for_random_statement(
            statement, import_statement_lst
        ...
        print(statement, import_statement_lst, fix_statement)
        # 8
        statement, import_statement_lst = "    s_ = scale*random.random()", [
            "import random"
        ]
        fix_statement = return_fix_statement_for_random_statement(
            statement, import_statement_lst
        ...
        print(statement, import_statement_lst, fix_statement)
        # 9
        statement, import_statement_lst = "X = np.random.uniform(0.,1.,N)", [
            "import numpy as np"
        ]
        fix_statement = return_fix_statement_for_random_statement(
            statement, import_statement_lst
        ...
        print(statement, import_statement_lst, fix_statement)
        # 10
        statement, import_statement_lst = "X = np.random.random(N)", [
            "import numpy as np"
        ]
        fix_statement = return_fix_statement_for_random_statement(
            statement, import_statement_lst
        ...
        print(statement, import_statement_lst, fix_statement)
        # 11
        statement, import_statement_lst = "y1 = 0.2*x + np.random.rand(1000)", [
            "import numpy as np"
        ]
        fix_statement = return_fix_statement_for_random_statement(
            statement, import_statement_lst
